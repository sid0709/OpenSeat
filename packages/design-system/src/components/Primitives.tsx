...
export type { StackProps, HStackProps, VStackProps, StackAlignment } from "@astryxdesign/core/Stack";

export { Text, Heading } from "@astryxdesign/core/Text";
export type { TextProps, TextType, TextColor, TextWeight, HeadingProps, HeadingLevel } from "@astryxdesign/core/Text";
