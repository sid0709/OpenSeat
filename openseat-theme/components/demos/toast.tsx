  ...
  return (
    <Examples>
      <Preview label="Tones, title, and action">
        <Row>
          <Button label="Info" variant="secondary" onClick={() => push({ tone: "neutral", title: "Invite sent", message: "Alex has the link." })} />
          <Button label="Success" variant="secondary" onClick={() => push({ tone: "success", title: "Saved", message: "The brief is updated." })} />
          <Button label="Warning" variant="secondary" onClick={() => push({ tone: "warning", title: "Low bids", message: "Only one person has responded." })} />
          <Button label="Error"
            variant="secondary"
            onClick={() =>
